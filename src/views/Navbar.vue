<template>
  <div>
    <p class="text-3xl font-bold mb-4 pl-4 text-green-500">Navbar Styles</p>
    ...
    <nav class="flex items-center justify-between flex-wrap bg-teal-500">
      ...
      'w-full block flex-grow lg:flex lg:items-center lg:w-auto hidden': this.navbarCollapsed3 === true
        ...
        <div class="text-sm lg:w-full lg:flex lg:justify-start items-center h-20">
          ...
          <input class="mr-4 w-full appearance-none block bg-gray-200 text-gray-700 py-3 px-4 leading-tight focus:outline-none focus:bg-white" type="text" placeholder="Search">
        </div>
      </div>
    </nav>
